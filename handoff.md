...
```json
{
  ...
  "nextSteps": [
    ...
    { "title": "Eyeball the new OSM attribution in a signed-in browser session; it builds and unit-tests clean but has not been seen rendered (the main shell is behind auth)", "est": 0.1, "owner": "oscar", "phase": "Phase 6 - Beta hardening", "plan": "redesign" },
